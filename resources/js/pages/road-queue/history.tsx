...
import RoadQueueController from '@/actions/App/Http/Controllers/RoadQueue/RoadQueueController';
...
function RoadQueueHistory({
    ...
    function navigate(overrides: Partial<RoadQueueHistoryFilters>) {
    ...
    return (
        <>
            <Head title="Road Queue — History" />
            <div className="space-y-6 p-4 sm:p-6">
                <PageHeader
                    icon={MapPinned}
                    title="Road Queue — History"
                ...
                <section>
                    <div className="mb-2 flex flex-wrap items-center justify-between gap-3">
                        ...
                        <CsvExportButton
                            ...
                            filename="road-queue-tat-history.csv"
                        />
                    </div>
                    <Card>
                        <TatHistoryFilterBar
                            ...
                            showStatus
                        />
                        <TatHistoryTable rows={tatHistory.data} showStatus />
                ...
                <section>
                    <div className="mb-2 flex flex-wrap items-center justify-between gap-3">
                        ...
                        <CsvExportButton
                            ...
                            filename="road-queue-high-elapsed-transactions.csv"
                        />
                    </div>
                    <Card>
                        ...
                        <HighElapsedTransactionsTable
                            ...
                            dateColumnLabel="Precheck Time"
                            dateColumnKey="precheck_time"
                        />
                        <div className="mt-4 flex items-center justify-between">
                            <p className="text-xs text-neutral-500">
...
RoadQueueHistory.layout = (page: ReactNode) => (
    <PortalLayout>{page}</PortalLayout>
);

export default RoadQueueHistory;
